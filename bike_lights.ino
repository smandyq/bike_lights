...
//turn on interrupt friendliness in the strip library
//bool PololuLedStripBase::interruptFriendly = true;

// Create an ledStrip object and specify the pin it will use.
PololuLedStrip<9> ledStrip;

//create an array of rgb colors to send
rgb_color colors[LED_COUNT];

//create an end pointer so we know the end of the array.
...
void loop()  //once per "frame" of data
{
  ...
  //update_breathe();
  update_blank();
  update_stars(colors, colors_end);
  //update_cop();
